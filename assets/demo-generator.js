(function () {
  ...
  function buildPreview(data) {
    ...
    return '<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">' +
      ...
      '<section class="about" id="nosotros"><div class="wrap about-grid"><div class="about-media"><img src="' + images[1] + '" alt="' + imageAlt + '" loading="lazy" decoding="async"><img src="' + images[2] + '" alt="Detalle de ' + business + '" loading="lazy" decoding="async"></div><div><div class="section-kicker">Nuestra manera de hacer</div><h2>' + aboutTitle + '</h2><p>' + about + '</p><p>En ' + business + ' escuchamos lo que necesitas, te explicamos cada paso y cuidamos la experiencia de principio a fin.</p><p class="quote">Cercanía para entenderte. Criterio para ofrecerte una solución que de verdad encaje.</p></div></div></section>' +
